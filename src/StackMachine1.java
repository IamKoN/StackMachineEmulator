...
public class StackMachine1 {
 	...
 	String inFile = sc.nextLine();
        ...
        while (!endOfFile) {
            try {
                ...
                StackMachine1.this.setInstruction(counter, Integer.parseInt(bits6,2), Integer.parseInt(bits16,2));
    ...
    public void setInstruction(int loc, int opcode) {
        StackMachine1.this.setInstruction(loc, opcode, 0);
    }
    ...
    public static void main(String[] args) throws IOException {
        // Stack Machine object
        StackMachine1 vm = new StackMachine1();
        vm.readBinFile();   
